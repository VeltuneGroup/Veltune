...
val applicationIdOverride = System.getenv("VELTUNE_APPLICATION_ID")?.takeIf { it.isNotBlank() }
val appNameOverride = System.getenv("VELTUNE_APP_NAME")?.takeIf { it.isNotBlank() }
val debugKeystorePathOverride = System.getenv("VELTUNE_DEBUG_KEYSTORE_PATH")?.takeIf { it.isNotBlank() }
val debugKeystorePassword = System.getenv("VELTUNE_DEBUG_KEYSTORE_PASSWORD")?.takeIf { it.isNotBlank() } ?: "android"
val debugKeyAlias = System.getenv("VELTUNE_DEBUG_KEY_ALIAS")?.takeIf { it.isNotBlank() } ?: "androiddebugkey"
val debugKeyPassword = System.getenv("VELTUNE_DEBUG_KEY_PASSWORD")?.takeIf { it.isNotBlank() } ?: "android"
...
android {
    ...
    defaultConfig {
        ...
        versionCode = 147
        versionName = "13.4.3"
        resValue("string", "app_name", appNameOverride ?: "Veltune")
    ...
    buildTypes {
        ...
        debug {
            ...
            if (appNameOverride == null) {
                resValue("string", "app_name", "Veltune Debug")
            }
            signingConfig =
