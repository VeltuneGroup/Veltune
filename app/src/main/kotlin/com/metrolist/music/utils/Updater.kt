...
object Updater {
    ...
    private const val GITHUB_API_BASE = "https://api.github.com/repos/VeltuneGroup/Veltune"
    ...
    private fun parseAssets(assetsArray: JSONArray): List<ReleaseAsset> {
        ...
        for (i in 0 until assetsArray.length()) {
            ...
            val (arch, variant) = when {
                name == "Veltune.apk" -> "universal" to "foss"
                name == "Veltune-with-Google-Cast.apk" -> "universal" to "gms"
