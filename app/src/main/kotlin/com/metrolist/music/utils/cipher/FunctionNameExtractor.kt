...
object FunctionNameExtractor {
    ...
    private val SIG_FUNCTION_PATTERNS = listOf(
        ...
        Regex("""\b([a-zA-Z0-9$]{2,})\s*=\s*function\s*\(\s*[a-zA-Z0-9$]+\s*\)\s*\{\s*[a-zA-Z0-9$]+\s*=\s*[a-zA-Z0-9$]+\.split\s*\(\s*""\s*\)"""),
        Regex("""\b([a-zA-Z0-9$]{2,})\s*=\s*function\s*\(\s*[a-zA-Z0-9$]+\s*\)\s*\{\s*var\s+[a-zA-Z0-9$]+\s*=\s*[a-zA-Z0-9$]+\.split\s*\(\s*""\s*\)"""),
        Regex("""\b([a-zA-Z0-9$]{2,})\s*=\s*function\s*\(\s*a\s*\)\s*\{\s*a\s*=\s*a\.split\(""\)"""),
        Regex("""([a-zA-Z0-9$]+)\s*=\s*function\s*\([a-zA-Z0-9$]+\)\s*\{\s*\w\s*=\s*\w\.split\(""\)"""),
        Regex("""\b([a-zA-Z0-9$]{2,})\s*=\s*function\s*\(\s*a\s*\)\s*\{\s*var\s+b\s*=\s*a\.split\(""\);\s*b\."""),
    )
    ...
    private val N_FUNCTION_PATTERNS = listOf(
        ...
        Regex("""\b([a-zA-Z0-9$]{2,})\s*=\s*function\s*\(\s*[a-zA-Z0-9$]+\s*\)\s*\{\s*var\s+[a-zA-Z0-9$]+\s*=\s*[a-zA-Z0-9$]+\.split\s*\(\s*""\s*\);\s*var\s+[a-zA-Z0-9$]+\s*=\s*\["""),
        Regex("""\b([a-zA-Z0-9$]{2,})\s*=\s*function\s*\(\s*[a-zA-Z0-9$]+\s*\)\s*\{\s*var\s+[a-zA-Z0-9$]+\s*=\s*[a-zA-Z0-9$]+\.split\s*\(\s*""\s*\);\s*[a-zA-Z0-9$]+\s*="""),
        Regex("""\.get\("n"\)\)\s*&&\s*\w\.set\("n",([a-zA-Z0-9$]+)\(\w\)\)"""),
        Regex("""\.get\("n"\)\)\s*&&\s*\w\.set\("n",([a-zA-Z0-9$]+)\[\d+\]\(\w\)\)"""),
    )
