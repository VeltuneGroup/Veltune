...
object CipherDeobfuscator {
    ...
    private suspend fun getOrCreateWebView(forceRefresh: Boolean): CipherWebView? {
        ...
        if (sigInfo == null && nFuncInfo == null) {
            Timber.tag(TAG).e("Could not extract ANY function info from player JS (sig/n both null)")
            // We still create the WebView for brute-force discovery of n-function
        }
